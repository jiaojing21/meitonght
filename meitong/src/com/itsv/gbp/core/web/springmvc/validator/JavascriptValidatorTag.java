...
package com.itsv.gbp.core.web.springmvc.validator;
...
/**
 * javascript校验代码标签。<br>
 * 我们的字段有前缀，原有的生成标签不适合。<br>
 * 
 * @author <a href="mailto:Ace8@live.cn">admin</a>
 * @since 2006-9-13 上午11:44:47
 * 
...
public class JavascriptValidatorTag extends BodyTagSupport {
	...
	private static final long serialVersionUID = -6874814457279374578L;
			...
			if ("true".equalsIgnoreCase(dynamicJavascript)) {
				...
				for (Iterator i = lActions.iterator(); i.hasNext();) {
					...
					for (Iterator x = form.getFields().iterator(); x.hasNext();) {
						...
						//给字段加前缀fieldPrefix
						results.append("     this." + jscriptVar + " = new Array(\"" + getFieldPrefix()
