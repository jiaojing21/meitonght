...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		 ...
		 */
		BackgroundGenerator backgroundGenerator = new GradientBackgroundGenerator(imageWidth, imageHeight,
		...
		TextPaster _textPaster = new DecoratedRandomTextPaster(minAcceptedWordLength, maxAcceptedWordLength,
				scg, new TextDecorator[] { new BaffleTextDecorator(new Integer(1), Color.white) });
